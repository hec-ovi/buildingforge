...
| Massing and secondary detail | Default plates are rectangular on the shared construction grid. Explicit shape options control curved forms and setbacks. Seeded use and wealth rules select structural piers, facade relief, service equipment, roofs and fire escapes. |
