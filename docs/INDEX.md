...
- src/layout: style freeze, massing and the core plate depth it keeps, floor stack, facade bays, glazing pane grids, facade relief, the per-face obstacle map and its clear-rectangle scan, condenser unit clusters, features. Depends on core and rules.
