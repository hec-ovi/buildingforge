...
- src/mesh: winding-safe primitives, shared tube sections, fitted facade relief and mast geometry, trapezoid wall cutting, caps, mesher, the wall depth measure. Depends on layout.
