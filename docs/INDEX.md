...
- src/rules: template families, the researched numeric tables (docs/RESEARCH.md) and the signage glyph cells.
- src/layout: style freeze, massing, floor stack, facade bays, glazing pane grids, features. Depends on core and rules.
