...
Built-in image generation supplies the eight albedo sources. Materials `from-image` derives the dry PBR maps, including packed metallic-roughness. Runtime generation uses the stored maps offline.
