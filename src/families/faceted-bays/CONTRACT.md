...
- Decoration adds 1.5 m panel divisions, vertical pier ribs, concrete caps and framed 1:2 portrait screens stacked inside a solid panel field. The 22 mm fixing heads at each panel corner come from the panel map. `adScreens: off` omits screens. The builder's prior floor owner is restored.
