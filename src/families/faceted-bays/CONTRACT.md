...
- Decoration adds 1.5 m panel divisions, vertical pier ribs, concrete caps and framed 1:2 portrait screens stacked inside a solid panel field. Panel fixing heads depend on the Materials map request in [issues](../../../docs/ISSUES.md). `adScreens: off` omits screens. The builder's prior floor owner is restored.
