...
- Decoration adds 1.5 m panel divisions, vertical pier ribs, concrete caps and framed 1:2 portrait screens stacked inside a solid panel field. Ivory panels use `cyberpunk/ivory-panel/mid#fixings` with world metre UVs and a 1.5 x 1.5 m repeat for the 22 mm fixing heads. `adScreens: off` omits screens. The builder's prior floor owner is restored.
...
- Narrow slots place glass 0.34 m inward with 0.035 m frames; bay glazing remains 0.14 m inward. Slot openings retain their 0.4 m width.
